    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description:
            "El producto ha sido agregado correctamente y comenzaremos a rastrear su precio.",
        });
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="https://www.venex.com.ar/productos/ejemplo"
                  {...field}
                />
              </FormControl>
              <FormDescription>
                Ingresa la URL completa del producto que deseas rastrear
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
